                    ...
                    {isAdmin && (
                      <>
                        <td className="p-4 text-center font-mono text-muted-foreground">
                          {Number(d.gsl_avg || 0).toFixed(2)}
                        </td>
                        <td className="p-4 text-center font-mono text-muted-foreground">
                          {Number(d.chits_score || 0).toFixed(2)}
                        </td>
                        <td className="p-4 text-center font-mono text-muted-foreground">
                          {Number(d.mod_avg || 0).toFixed(2)}
                        </td>
                        <td className="p-4 text-center font-mono font-bold text-primary">
                          {Number(d.total_score || 0).toFixed(2)}
                        </td>
                      </>
                    )}
                  </tr>
